...
All tests require BURBLEBOY_HOME to be set.  Running tests with the .runtests.pl script will set this correctly:
...
```
    $ BURBLEBOY_HOME=.. perl -d 000-compile.t
```
